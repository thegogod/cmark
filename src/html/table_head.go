...
func (self TableHeadElement) Render(scope *ast.Scope) []byte {
	return self.element.Render(scope)
}

func (self TableHeadElement) RenderPretty(scope *ast.Scope, indent string) []byte {
...
func (self TableHeadElement) Validate(scope *ast.Scope) error {
	return nil
}

func (self TableHeadElement) Evaluate(scope *ast.Scope) (reflect.Value, error) {
