...
func (self BodyElement) Render(scope *ast.Scope) []byte {
	return self.element.Render(scope)
}

func (self BodyElement) RenderPretty(scope *ast.Scope, indent string) []byte {
...
func (self BodyElement) Validate(scope *ast.Scope) error {
	return nil
}

func (self BodyElement) Evaluate(scope *ast.Scope) (reflect.Value, error) {
