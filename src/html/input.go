...
func (self InputElement) Render(scope *ast.Scope) []byte {
	return self.element.Render(scope)
}

func (self InputElement) RenderPretty(scope *ast.Scope, indent string) []byte {
...
func (self InputElement) Validate(scope *ast.Scope) error {
	return nil
}

func (self InputElement) Evaluate(scope *ast.Scope) (reflect.Value, error) {
