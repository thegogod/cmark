...
func (self PreElement) Render(scope *ast.Scope) []byte {
	return self.element.Render(scope)
}

func (self PreElement) RenderPretty(scope *ast.Scope, indent string) []byte {
...
func (self PreElement) Validate(scope *ast.Scope) error {
	return nil
}

func (self PreElement) Evaluate(scope *ast.Scope) (reflect.Value, error) {
