...
func (self TemplateElement) Render(scope *ast.Scope) []byte {
	return self.element.Render(scope)
}

func (self TemplateElement) RenderPretty(scope *ast.Scope, indent string) []byte {
...
func (self TemplateElement) Validate(scope *ast.Scope) error {
	return nil
}

func (self TemplateElement) Evaluate(scope *ast.Scope) (reflect.Value, error) {
