...
func (self SpanElement) Render(scope *ast.Scope) []byte {
	return self.element.Render(scope)
}

func (self SpanElement) RenderPretty(scope *ast.Scope, indent string) []byte {
...
func (self SpanElement) Validate(scope *ast.Scope) error {
	return nil
}

func (self SpanElement) Evaluate(scope *ast.Scope) (reflect.Value, error) {
