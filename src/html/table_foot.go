...
func (self TableFootElement) Render(scope *ast.Scope) []byte {
	return self.element.Render(scope)
}

func (self TableFootElement) RenderPretty(scope *ast.Scope, indent string) []byte {
...
func (self TableFootElement) Validate(scope *ast.Scope) error {
	return nil
}

func (self TableFootElement) Evaluate(scope *ast.Scope) (reflect.Value, error) {
