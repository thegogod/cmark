...
func (self TableRowElement) Render(scope *ast.Scope) []byte {
	return self.element.Render(scope)
}

func (self TableRowElement) RenderPretty(scope *ast.Scope, indent string) []byte {
...
func (self TableRowElement) Validate(scope *ast.Scope) error {
	return nil
}

func (self TableRowElement) Evaluate(scope *ast.Scope) (reflect.Value, error) {
