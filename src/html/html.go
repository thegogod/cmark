...
func (self HtmlElement) Render(scope *ast.Scope) []byte {
	return self.element.Render(scope)
}

func (self HtmlElement) RenderPretty(scope *ast.Scope, indent string) []byte {
...
func (self HtmlElement) Validate(scope *ast.Scope) error {
	return nil
}

func (self HtmlElement) Evaluate(scope *ast.Scope) (reflect.Value, error) {
